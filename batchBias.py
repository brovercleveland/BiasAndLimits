...
Notification            = Error
Executable              = ../batchWrapper.sh
Arguments               = --tev {0} --lepton {1} --cat {2} --genFunc {3} --mass {4} --trials {5} --job {6} --plotEvery {7} --batch True
Rank                    = Mips
...
transfer_input_files    = ../rooFitBuilder.py, ../CMSStyle.C, ../configLimits.py, ../toyStructs.py, ../biasStudy_toyMaker.py
Queue
