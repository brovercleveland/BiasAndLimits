...
def doCombinedBG():
  print 'opening file'
  f_ws_muon_2012 = TFile('workspacemu2012.root')
  f_ws_electron_2012 = TFile('workspaceel2012.root')
  f_ws_muon_2011 = TFile('workspacemu2011.root')
  f_ws_electron_2011 = TFile('workspaceel2011.root')
  ...
  print 'getting ws'
  myws_muon_2012 = f_ws_muon_2012.Get("w")
  myws_electron_2012 = f_ws_electron_2012.Get("w")
  myws_muon_2011 = f_ws_muon_2011.Get("w")
  myws_electron_2011 = f_ws_electron_2011.Get("w")
...
#myws_electron_2011.Print();
  ...
  mzg_muon_2012 = myws_muon_2012.var("mass")
  mzg_muon_2012.setBins(65)
  mzg_muon_2012.Print()
  mzg_electron_2012 = myws_electron_2012.var("mass")
  mzg_electron_2012.setBins(65)
  mzg_electron_2012.Print()
  mzg_muon_2011 = myws_muon_2011.var("mass")
  mzg_muon_2011.setBins(65)
  mzg_muon_2011.Print()
  mzg_electron_2011 = myws_electron_2011.var("mass")
  mzg_electron_2011.setBins(65)
...
#make the signifcance weight dictionaries
  ...
  ee_2012_bg_cat1 = myws_electron_2012.pdf('MzgBkgA'); bgPdfList.append(ee_2012_bg_cat1); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2012')
  ee_2012_bg_cat2 = myws_electron_2012.pdf('MzgBkgC'); bgPdfList.append(ee_2012_bg_cat2); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2012')
  ee_2012_bg_cat3 = myws_electron_2012.pdf('MzgBkgD'); bgPdfList.append(ee_2012_bg_cat3); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2012')
  ee_2012_bg_cat4 = myws_electron_2012.pdf('MzgBkgB'); bgPdfList.append(ee_2012_bg_cat4); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2012')
  mumu_2012_bg_cat1 = myws_muon_2012.pdf('MzgBkgA'); bgPdfList.append(mumu_2012_bg_cat1); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2012')
  mumu_2012_bg_cat2 = myws_muon_2012.pdf('MzgBkgC'); bgPdfList.append(mumu_2012_bg_cat2); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2012')
  mumu_2012_bg_cat3 = myws_muon_2012.pdf('MzgBkgD'); bgPdfList.append(mumu_2012_bg_cat3); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2012')
  mumu_2012_bg_cat4 = myws_muon_2012.pdf('MzgBkgB'); bgPdfList.append(mumu_2012_bg_cat4); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2012')

  ee_2011_bg_cat1 = myws_electron_2011.pdf('MzgBkgA'); bgPdfList.append(ee_2011_bg_cat1); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2011')
  ee_2011_bg_cat2 = myws_electron_2011.pdf('MzgBkgC'); bgPdfList.append(ee_2011_bg_cat2); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2011')
  ee_2011_bg_cat3 = myws_electron_2011.pdf('MzgBkgD'); bgPdfList.append(ee_2011_bg_cat3); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2011')
  ee_2011_bg_cat4 = myws_electron_2011.pdf('MzgBkgB'); bgPdfList.append(ee_2011_bg_cat4); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2011')
  mumu_2011_bg_cat1 = myws_muon_2011.pdf('MzgBkgA'); bgPdfList.append(mumu_2011_bg_cat1); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2011')
  mumu_2011_bg_cat2 = myws_muon_2011.pdf('MzgBkgC'); bgPdfList.append(mumu_2011_bg_cat2); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2011')
  mumu_2011_bg_cat3 = myws_muon_2011.pdf('MzgBkgD'); bgPdfList.append(mumu_2011_bg_cat3); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2011')
  mumu_2011_bg_cat4 = myws_muon_2011.pdf('MzgBkgB'); bgPdfList.append(mumu_2011_bg_cat4); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2011')

  ee_2012_norm_cat1 = myws_electron_2012.var('mzg_bkg_normA'); bgNormList.append(ee_2012_norm_cat1); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_ee_2012')
  ee_2012_norm_cat2 = myws_electron_2012.var('mzg_bkg_normC'); bgNormList.append(ee_2012_norm_cat2); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_ee_2012')
  ee_2012_norm_cat3 = myws_electron_2012.var('mzg_bkg_normD'); bgNormList.append(ee_2012_norm_cat3); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_ee_2012')
  ee_2012_norm_cat4 = myws_electron_2012.var('mzg_bkg_normB'); bgNormList.append(ee_2012_norm_cat4); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_ee_2012')
  mumu_2012_norm_cat1 = myws_muon_2012.var('mzg_bkg_normA'); bgNormList.append(mumu_2012_norm_cat1); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_mumu_2012')
  mumu_2012_norm_cat2 = myws_muon_2012.var('mzg_bkg_normC'); bgNormList.append(mumu_2012_norm_cat2); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_mumu_2012')
  mumu_2012_norm_cat3 = myws_muon_2012.var('mzg_bkg_normD'); bgNormList.append(mumu_2012_norm_cat3); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_mumu_2012')
  mumu_2012_norm_cat4 = myws_muon_2012.var('mzg_bkg_normB'); bgNormList.append(mumu_2012_norm_cat4); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_mumu_2012')

  ee_2011_norm_cat1 = myws_electron_2011.var('mzg_bkg_normA'); bgNormList.append(ee_2011_norm_cat1); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_ee_2011')
  ee_2011_norm_cat2 = myws_electron_2011.var('mzg_bkg_normC'); bgNormList.append(ee_2011_norm_cat2); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_ee_2011')
  ee_2011_norm_cat3 = myws_electron_2011.var('mzg_bkg_normD'); bgNormList.append(ee_2011_norm_cat3); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_ee_2011')
  ee_2011_norm_cat4 = myws_electron_2011.var('mzg_bkg_normB'); bgNormList.append(ee_2011_norm_cat4); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_ee_2011')
  mumu_2011_norm_cat1 = myws_muon_2011.var('mzg_bkg_normA'); bgNormList.append(mumu_2011_norm_cat1); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_mumu_2011')
  mumu_2011_norm_cat2 = myws_muon_2011.var('mzg_bkg_normC'); bgNormList.append(mumu_2011_norm_cat2); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_mumu_2011')
  mumu_2011_norm_cat3 = myws_muon_2011.var('mzg_bkg_normD'); bgNormList.append(mumu_2011_norm_cat3); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_mumu_2011')
  mumu_2011_norm_cat4 = myws_muon_2011.var('mzg_bkg_normB'); bgNormList.append(mumu_2011_norm_cat4); bgNormList[-1].SetName(bgNormList[-1].GetName()+'_mumu_2011')
  '''
  ee_2012_bg_cat1 = myws_electron_2012.pdf('MzgBkgShapePolyTruthA'); bgPdfList.append(ee_2012_bg_cat1); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2012')
  ee_2012_bg_cat2 = myws_electron_2012.pdf('MzgBkgShapePolyTruthC'); bgPdfList.append(ee_2012_bg_cat2); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2012')
  ee_2012_bg_cat3 = myws_electron_2012.pdf('MzgBkgShapePolyTruthD'); bgPdfList.append(ee_2012_bg_cat3); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2012')
  ee_2012_bg_cat4 = myws_electron_2012.pdf('MzgBkgShapePolyTruthB'); bgPdfList.append(ee_2012_bg_cat4); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2012')
  mumu_2012_bg_cat1 = myws_muon_2012.pdf('MzgBkgShapePolyTruthA'); bgPdfList.append(mumu_2012_bg_cat1); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2012')
  mumu_2012_bg_cat2 = myws_muon_2012.pdf('MzgBkgShapePolyTruthC'); bgPdfList.append(mumu_2012_bg_cat2); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2012')
  mumu_2012_bg_cat3 = myws_muon_2012.pdf('MzgBkgShapePolyTruthD'); bgPdfList.append(mumu_2012_bg_cat3); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2012')
  mumu_2012_bg_cat4 = myws_muon_2012.pdf('MzgBkgShapePolyTruthB'); bgPdfList.append(mumu_2012_bg_cat4); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2012')

  ee_2011_bg_cat1 = myws_electron_2011.pdf('MzgBkgShapePolyTruthA'); bgPdfList.append(ee_2011_bg_cat1); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2011')
  ee_2011_bg_cat2 = myws_electron_2011.pdf('MzgBkgShapePolyTruthC'); bgPdfList.append(ee_2011_bg_cat2); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2011')
  ee_2011_bg_cat3 = myws_electron_2011.pdf('MzgBkgShapePolyTruthD'); bgPdfList.append(ee_2011_bg_cat3); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2011')
  ee_2011_bg_cat4 = myws_electron_2011.pdf('MzgBkgShapePolyTruthB'); bgPdfList.append(ee_2011_bg_cat4); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_ee_2011')
  mumu_2011_bg_cat1 = myws_muon_2011.pdf('MzgBkgShapePolyTruthA'); bgPdfList.append(mumu_2011_bg_cat1); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2011')
  mumu_2011_bg_cat2 = myws_muon_2011.pdf('MzgBkgShapePolyTruthC'); bgPdfList.append(mumu_2011_bg_cat2); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2011')
  mumu_2011_bg_cat3 = myws_muon_2011.pdf('MzgBkgShapePolyTruthD'); bgPdfList.append(mumu_2011_bg_cat3); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2011')
  mumu_2011_bg_cat4 = myws_muon_2011.pdf('MzgBkgShapePolyTruthB'); bgPdfList.append(mumu_2011_bg_cat4); bgPdfList[-1].SetName(bgPdfList[-1].GetName()+'_mumu_2011')
  '''
...
#    data_muon_2012.append(myws_muon_2012.data('dsdatacat'+str(i)))
    ...
    data_muon_2012.append(myws_muon_2012.data('data'+str(i)))
    data_electron_2012.append(myws_electron_2012.data('data'+str(i)))
    data_muon_2011.append(myws_muon_2011.data('data'+str(i)))
    data_electron_2011.append(myws_electron_2011.data('data'+str(i)))

    tmpMu2011_2011 = myws_muon_2011.data('data'+str(i)).Clone()
    tmpMu2011_All  = myws_muon_2011.data('data'+str(i)).Clone()
    tmpEl2011_2011 = myws_electron_2011.data('data'+str(i)).Clone()
    tmpEl2011_All  = myws_electron_2011.data('data'+str(i)).Clone()
    tmpMu2012_2012 = myws_muon_2012.data('data'+str(i)).Clone()
    tmpMu2012_All  = myws_muon_2012.data('data'+str(i)).Clone()
    tmpEl2012_2012 = myws_electron_2012.data('data'+str(i)).Clone()
    tmpEl2012_All  = myws_electron_2012.data('data'+str(i)).Clone()
...
# make plots for 2011, 2012, 2011+2012, various binnings
  ...
  leg1 = TLegend(0.55, 0.45, 0.85, 0.75)
  ...
  if makeNewResults:
    ...
    raw_input('Hit any key to continue')
    fit_s = pdfDict['All'].fitTo(dataDict['All'],RooFit.Save(), RooFit.Strategy(2))
  ...
  for year in dataDict.keys():
    for width in binningDict.keys():
      mzg_muon_2012.setRange(115,180)
      mzg_muon_2012.setBins(65)
...
#test the error bands
      ...
      frameW = mzg_muon_2012.frame(115,180)
