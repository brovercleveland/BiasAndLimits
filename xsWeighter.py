...
def LumiXSWeighter(year, lepton, sig, mass, nEvt):
  ...
  if(year is '2011'):
    if(sig is 'gg'):
      ...
      if(mass is '120'): LumiXSWeight = nEvt/(0.6561*0.00111*0.10098*1000*0.100974)
      if(mass is '125'): LumiXSWeight = nEvt/(0.5729*0.00154*0.10098*1000*0.100974)
      if(mass is '130'): LumiXSWeight = nEvt/(0.5008*0.00195*0.10098*1000*0.100974)
      if(mass is '135'): LumiXSWeight = nEvt/(0.4390*0.00227*0.10098*1000*0.100974)
      if(mass is '140'): LumiXSWeight = nEvt/(0.3857*0.00246*0.10098*1000*0.100974)
      if(mass is '145'): LumiXSWeight = nEvt/(0.3406*0.00248*0.10098*1000*0.100974)
      if(mass is '150'): LumiXSWeight = nEvt/(0.3001*0.00231*0.10098*1000*0.100974)
      if(mass is '155'): LumiXSWeight = nEvt/(0.2646*0.00191*0.10098*1000*0.100974)
      if(mass is '160'): LumiXSWeight = nEvt/(0.2291*0.00116*0.10098*1000*0.100974)

    elif(sig is 'zh'):
      if(mass is '120'): LumiXSWeight = nEvt/(0.3598*0.00111*0.10098*1000*0.100974)
      if(mass is '125'): LumiXSWeight = nEvt/(0.3158*0.00154*0.10098*1000*0.100974)
      if(mass is '130'): LumiXSWeight = nEvt/(0.2778*0.00195*0.10098*1000*0.100974)
      if(mass is '135'): LumiXSWeight = nEvt/(0.2453*0.00227*0.10098*1000*0.100974)
      if(mass is '140'): LumiXSWeight = nEvt/(0.2172*0.00246*0.10098*1000*0.100974)
      if(mass is '145'): LumiXSWeight = nEvt/(0.1930*0.00248*0.10098*1000*0.100974)
      if(mass is '150'): LumiXSWeight = nEvt/(0.1713*0.00231*0.10098*1000*0.100974)
      if(mass is '155'): LumiXSWeight = nEvt/(0.1525*0.00191*0.10098*1000*0.100974)
      if(mass is '160'): LumiXSWeight = nEvt/(0.1334*0.00116*0.10098*1000*0.100974)
    ...
    if(sig is 'gg'):
      ...
      if(mass is '125'): LumiXSWeight = nEvt/(19.52*0.00154*0.100974*1000)
      ...
      if(mass is '120'): LumiXSWeight = nEvt/(0.7966*0.00111*0.10098*1000*0.100974)
      if(mass is '125'): LumiXSWeight = nEvt/(0.6966*0.00154*0.10098*1000*0.100974)
      if(mass is '130'): LumiXSWeight = nEvt/(0.6095*0.00195*0.10098*1000*0.100974)
      if(mass is '135'): LumiXSWeight = nEvt/(0.5351*0.00227*0.10098*1000*0.100974)
      if(mass is '140'): LumiXSWeight = nEvt/(0.4713*0.00246*0.10098*1000*0.100974)
      if(mass is '145'): LumiXSWeight = nEvt/(0.4164*0.00248*0.10098*1000*0.100974)
      if(mass is '150'): LumiXSWeight = nEvt/(0.3681*0.00231*0.10098*1000*0.100974)
      if(mass is '155'): LumiXSWeight = nEvt/(0.3252*0.00191*0.10098*1000*0.100974)
      if(mass is '160'): LumiXSWeight = nEvt/(0.2817*0.00116*0.10098*1000*0.100974)

    elif(sig is 'zh'):
      if(mass is '120'): LumiXSWeight = nEvt/(0.4483*0.00111*0.10098*1000*0.100974)
      if(mass is '125'): LumiXSWeight = nEvt/(0.3943*0.00154*0.10098*1000*0.100974)
      if(mass is '130'): LumiXSWeight = nEvt/(0.3473*0.00195*0.10098*1000*0.100974)
      if(mass is '135'): LumiXSWeight = nEvt/(0.3074*0.00227*0.10098*1000*0.100974)
      if(mass is '140'): LumiXSWeight = nEvt/(0.2728*0.00246*0.10098*1000*0.100974)
      if(mass is '145'): LumiXSWeight = nEvt/(0.2424*0.00248*0.10098*1000*0.100974)
      if(mass is '150'): LumiXSWeight = nEvt/(0.2159*0.00231*0.10098*1000*0.100974)
      if(mass is '155'): LumiXSWeight = nEvt/(0.1923*0.00191*0.10098*1000*0.100974)
      if(mass is '160'): LumiXSWeight = nEvt/(0.1687*0.00116*0.10098*1000*0.100974)
